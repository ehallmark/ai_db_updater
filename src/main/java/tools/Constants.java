...
public class Constants {
    ...
    public static final String ASSIGNMENT_URL = "https://bulkdata.uspto.gov/data2/patent/application/redbook/fulltext";
   ...
   // public static final UrlCreator ASSIGNMENT_URL_CREATOR = assignmentUrlCreator(ASSIGNMENT_URL);
    ...
    //public static final AssignmentIterator DEFAULT_ASSIGNMENT_ITERATOR = new AssignmentIterator(DEFAULT_START_DATE, ZIP_PREFIX, DESTINATION_PREFIX, ASSIGNMENT_URL_CREATOR);
   ...
   // private static UrlCreator assignmentUrlCreator(String baseUrl) {
      //  return date -> baseUrl + "/" + date.getYear() + "/" + prefix + date.toString().replace("-", "").substring(2) + ".zip";
   // }
}
