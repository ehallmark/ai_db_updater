...
public class Constants {
    ...
    public static final UrlCreator GOOGLE_APP_CREATOR = defaultAppUrlCreator(GOOGLE_APP_URL);
    public static final UrlCreator USPTO_APP_CREATOR = defaultAppUrlCreator(USPTO_APP_URL);
    ...
    public static final PatentGrantIterator DEFAULT_PATENT_APPLICATION_ITERATOR = new PatentGrantIterator(DEFAULT_START_DATE, ZIP_PREFIX, DESTINATION_PREFIX, GOOGLE_APP_CREATOR, USPTO_APP_CREATOR);
